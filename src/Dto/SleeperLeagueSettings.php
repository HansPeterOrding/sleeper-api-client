...
class SleeperLeagueSettings
{
    ...
    private int $waiverDayOfWeek;

    private int $waiverClearDays;

    private int $waiverBudget;

    private int $type;

    private int $tradeReviewDays;

    private int $tradeDeadline;

    private int $taxiYears;

    private int $taxiSlots;

    private int $taxiDeadline;

    private int $taxiAllowVets;

    private int $startWeek;

    private int $reserveSlots;

    private int $reserveAllowSus;

    private int $reserveAllowOut;

    private int $reserveAllowDoubtful;

    private int $playoffWeekStart;

    private int $playoffType;

    private int $playoffTeams;

    private int $pickTrading;

    private int $offseasonAdds;
    ...
    private int $leagueAverageMatch;

    private int $lastScoredLeg;

    private int $lastReport;

    private int $draftRounds;

    private int $dailyWaiversHour;

    private int $dailyWaivers;

    private int $benchLock;
