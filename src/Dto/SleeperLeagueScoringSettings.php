...
{
    private float $fgRetYd;

    private float $tkl;

    private float $pass2pt;

    private float $krYd;

    private float $tklLoss;

    private float $passInt;

    private float $recYd;

    private float $idpSafe;

    private float $blkKickRetYd;

    private float $xpmiss;

    private float $fgm3039;

    private float $sackYd;

    private float $blkKick;

    private float $ptsAllow713;

    private float $idpFf;

    private float $bonusRushYd100;

    private float $ff;

    private float $fgm2029;

    private float $fgm4049;

    private float $ptsAllow16;

    private float $intRetYd;

    private float $stFumRec;

    private float $defPassDef;

    private float $passSack;

    private float $defStFf;

    private float $stFf;

    private float $ptsAllow2834;

    private float $passCmp;

    private float $idpInt;

    private float $fgm50p;

    private float $fumRec;

    private float $idpTkl;

    private float $bonusRecYd200;

    private float $qbHit;

    private float $defTd;

    private float $fgm019;

    private float $bonusPassYd300;

    private float $idpPassDef;

    private float $stTklSolo;

    private float $tklSolo;
    ...
    private float $ptsAllow0;

    private float $bonusRushYd200;

    private float $ptsAllow2127;

    private float $idpFumRec;

    private float $rec2pt;

    private float $rec;

    private float $fgmiss3039;

    private float $xpm;

    private float $tklAst;

    private float $idpSack;

    private float $stTd;

    private float $krTd;

    private float $defStFumRec;

    private float $defStTd;

    private float $sack;

    private float $idpTklAst;

    private float $rushAtt;

    private float $idpTklSolo;

    private float $fgm;

    private float $rush2pt;

    private float $recTd;

    private float $idpBlk;

    private float $ptsAllow35p;

    private float $ptsAllow1420;

    private float $rushYd;

    private float $prYd;

    private float $bonusPassYd400;

    private float $fumRetYd;
    ...
    private float $fgmiss019;

    private float $bonusRecYd100;

    private float $def2pt;

    private float $fumLost;

    private float $fgmiss2029;
    ...
    public function getIdpBlk(): float
    {
        return $this->idpBlk;
    }

    public function setIdpBlk(float $idpBlk): SleeperLeagueScoringSettings
    {
        $this->idpBlk = $idpBlk;
        return $this;
    }
